...
1. git clone https://github.com/porunov/acme_client.git
2. cd acme_client
3. gradlew build
4. cd build/libs/
...
3. Configure openssl to use alternative names. I.e. if you have only one domain you should skip this section
  ...
  2. edit your openssl cnf file and change next parameters (you should create your own [alt_names]). Add only alternative name to your [alt_names], do not put main domain (i.e. example.com) into your alt_names:
